...
import com.android.carparking.Booking.Slot_area;
import com.android.carparking.Booking.booking_slot1;
import com.android.carparking.R;
import com.android.carparking.login.LoginandregisterActivity;
import com.android.carparking.profile.driver_page;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.About) {
            ...
            Intent intent = new Intent("android.intent.action.VIEW",
                    Uri.parse("https://www.google.com/maps/@42.8474368,74.6192896,12z?entry=ttu"));
